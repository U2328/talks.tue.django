...
)  # (talks_tue/config/settings/base.py - 3 = talks_tue/)
APPS_DIR = ROOT_DIR.path("talks_tue")
...
MIGRATION_MODULES = {"sites": "talks_tue.contrib.sites.migrations"}
...
# Celery
# ------------------------------------------------------------------------------
INSTALLED_APPS += ["talks_tue.taskapp.celery.CeleryAppConfig"]
if USE_TZ:
